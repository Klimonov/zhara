...
jQuery(document).ready(function () {
	...
	var mainImgContainer = jQuery(".gall");
	var mainImgContainer1 = jQuery(".master1");
	var mainImgContainer2 = jQuery(".master2");
	var mainImgContainer3 = jQuery(".master3");
	var mainImgContainer4 = jQuery(".master4");
	var mainImgContainer5 = jQuery(".master5");
	var mainImgContainer6 = jQuery(".master6");
	...
	jQuery.fn.magnificPopup && mainImgContainer1.magnificPopup({
		delegate:     '.item .more-details',
		type:         'image',
		removalDelay: 600,
		mainClass:    'mfp-fade',
		gallery:      {
	...
	jQuery.fn.magnificPopup && mainImgContainer2.magnificPopup({
		delegate:     '.item .more-details',
		type:         'image',
		removalDelay: 600,
		mainClass:    'mfp-fade',
	...
	jQuery.fn.magnificPopup && mainImgContainer3.magnificPopup({
		delegate:     '.item .more-details',
		type:         'image',
		removalDelay: 600,
		mainClass:    'mfp-fade',
	...
	jQuery.fn.magnificPopup && mainImgContainer4.magnificPopup({
		delegate:     '.item .more-details',
		type:         'image',
		removalDelay: 600,
		mainClass:    'mfp-fade',
	...
	jQuery.fn.magnificPopup && mainImgContainer5.magnificPopup({
		delegate:     '.item .more-details',
		type:         'image',
		removalDelay: 600,
		mainClass:    'mfp-fade',
	...
	jQuery.fn.magnificPopup && mainImgContainer6.magnificPopup({
		delegate:     '.item .more-details',
		type:         'image',
		removalDelay: 600,
		mainClass:    'mfp-fade',
	...
	// Google Map
	function initialize() {
		var myLatLng   = new google.maps.LatLng(45.003426, 41.903642);
		var mapOptions = {
			zoom:               15,
			center:             myLatLng,
